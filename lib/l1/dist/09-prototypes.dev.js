...
console.log("================="); // so, JS does not have traditional inheritance, it has something called prototype inheritance

var dog = new _classes.Dog();
var p = Object.getPrototypeOf(dog);

do {
  console.log(p);
  p = Object.getPrototypeOf(p);
} while (p); // it looks like dog_instance -> animal_instance -> object_instance but this is not what happens
...
f.a = a; // a is before the function call, this is set to a
...
var p3 = Object.create(Foo.prototype);
Object.assign(p3, p2);
p3.log();