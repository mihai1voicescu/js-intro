...
'use strict'; // declares a variable in the current scope that can NOT be reassigned

var a = 0; // a = 1; will error
// declares a variable in the current scope that can be reassigned

var b = 1;
b = 2; // to print we use

console.log(a, b); // declares a variable in the current function scope that can be reassigned

var c = 1;
console.log(c);
c += 1;
console.log(c); // scope difference between var const and let
...
console.log(he); // console.log(d); will err
